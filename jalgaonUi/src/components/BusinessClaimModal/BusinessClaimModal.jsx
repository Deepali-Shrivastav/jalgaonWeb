                    ...
                    <>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button 
                                type="submit" 
                                disabled={submitting}
                                style={{ padding: '12px 20px', background: '#2563eb', color: '#fff', border: 'none', borderRadius: '6px', cursor: submitting ? 'not-allowed' : 'pointer', width: '100%', fontWeight: 'bold', fontSize: '16px', opacity: submitting ? 0.7 : 1 }}
                            >
