...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-hairline-soft pt-section pb-xl">
      <div className="max-w-container-max mx-auto px-xxl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-section mb-section">
          <div className="space-y-xl">
            ...
            <div className="flex gap-base">
              <a className="w-10 h-10 rounded-full bg-surface flex items-center justify-center text-secondary hover:bg-primary hover:text-white transition-all" href="#">
          ...
          <div>
            ...
            <ul className="space-y-base">
              ...
              <li><Link className="text-secondary hover:text-primary transition-colors" href="#">Careers</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-base">
              ...
              <li><Link className="text-secondary hover:text-primary transition-colors" href="#">Premium Listings</Link></li>
              <li><Link className="text-secondary hover:text-primary transition-colors" href="#">Advertising</Link></li>
              <li><Link className="text-secondary hover:text-primary transition-colors" href="#">Local News</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-xl border-t border-hairline-soft flex flex-col md:flex-row justify-between items-center gap-base">
          <p className="text-secondary text-sm">© 1995-2025 Jalgaon.com. All Rights Reserved.</p>
