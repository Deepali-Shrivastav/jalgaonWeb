...
class ShopListingAdmin(admin.ModelAdmin):
    list_display = ('business_name', 'user', 'city', 'status', 'is_trending')
    list_filter = ('status', 'city', 'is_trending', 'main_category')
    ...
    fieldsets = (
        ...
        ('Status & Moderation', {
            'fields': ('status', 'is_claimed', 'is_trending', 'trending_priority')
        }),
        ('Analytics', {
